...
def main():
    ...
    data_filepath = st.selectbox("**Seleccionar archivo de datos históricos**: (Trabajar en estos momentos con **datos_8.xlsx**)", archivos_disponibles)
    ...
    if st.button("Run Backtest"):
        ...
        datos = datos[(datos['Fecha'] >= fecha_inicio + timedelta(days=4))
                      & (datos['Fecha'] <= fecha_fin - timedelta(days=4))]
