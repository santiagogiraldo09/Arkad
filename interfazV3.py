...
def realizar_backtest(data_filepath, api_key, ticker, balance_inicial, pct_allocation, fixed_amount, allocation_type, fecha_inicio, fecha_fin, option_days=30, option_offset=0, trade_type='Close to Close', periodo='Diario', column_name='toggle_false', esce1=False):
    ...
    if "Trades_H1" in data_filepath or \
       "Trades_H1_Best1" in data_filepath or \
       "Trades_H1_Best2" in data_filepath or \
       "Trades_H1_Best3" in data_filepath:
    ...
    for date, row in data.iterrows():
        ...
        if "Trades_H1" or "Trades_H1_Best1" or "Trades_H1_Best2" or "Trades_H1_Best3" in data_filepath:
            ...
            if periodo == 'Diario':
                ...
                if 'probability' or 'Selecteed_Models' in data.columns:
